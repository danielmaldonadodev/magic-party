...
if (typeof document !== 'undefined' && !document.getElementById('professional-login-styles')) {
  const style = document.createElement('style')
  style.id = 'professional-login-styles'
        ...
        >
          <div className="professional-glass rounded-2xl p-8 sm:p-10">
            ...
            <div className="text-center mb-8">
              ...
              >
                <LogIn className={`w-10 h-10 ${theme.text.white}`} />
              </div>
              ...
              <p className={`text-lg ${theme.text.soft} font-medium`}>
                Accede a Magic Party para continuar
              </p>
            </div>
            ...
            {/* Error message */}
            {message && (
              <div className="mt-6 p-4 rounded-xl bg-red-50/80 border-2 border-red-200 animate-pulse-error">
